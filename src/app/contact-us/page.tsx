                            ...
                            <div className="col-md-5 call-us-wrap" >
                                ...
                                <div className="call-us mobileHide">
                                    <ul>
                                        ...
                                        <li className="phone-link Ind" data-aos="fade-up" data-aos-delay="300"><span>IND: </span><a href="tel:+917889101844">+91 7889101844</a></li>
                                        ...
                                        <li className="phone-link" data-aos="fade-up" data-aos-delay="300"><span>UK: </span><a href="tel:+447441913940">+44 7441913940</a></li>
                                ...
                                <div className="addressWrap">
                                    ...
                                    <div className="address">
                                        <p>F-209, Industrial area<br />
                                            Phase 8-B, Sector 74, Mohali, 160074 <br />+91 7889101844</p>
                                    </div>
                                </div>
                            </div>
