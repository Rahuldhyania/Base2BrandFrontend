...
import facebook from "../../../public/img/digitai-markating-packags/instagram.svg";
import Image from "next/image";

const SocialMediaMarketingI = () => {
  return (
    <>
      <section
        ...
        style={{
          backgroundImage:
            "url('./img/digitai-markating-packags/socialmediai.jpg')",
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          ...
                          className="accordion-collapse collapse"
                          aria-labelledby="panelsStayOpen-collapseNine"
                        >
                          <div className="accordion-body pb-0">
                            <div className="list d-flex flex-column gap-3">
                              <li>Shopify Website Creation and Setup</li>
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          ...
                          className="accordion-collapse collapse"
                          aria-labelledby="panelsStayOpen-collapseTen"
                        >
                          <div className="accordion-body pb-0">
                            <div className="list d-flex flex-column gap-3">
                              <li>Shopify Website Creation and Setup</li>
...
export default SocialMediaMarketingI;
