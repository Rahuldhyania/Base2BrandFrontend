      ...
      <div className="xxl_container">
        <div className="row">
          <div className="col-12 col-md-6 col-lg-5 mb-4 mb-lg-0">
            <div className="text-center text-md-start pt-md-5">
              <h2
              ...
              <div className="pt-4 pt-xxl-5 d-flex justify-content-md-start justify-content-center">
                <button
          ...
          <div className="col-12 col-lg-7">
            <div className="pt-0">
              <div className="MonthlyGrowthgraph">
                ...
                <div className="pt-1 pt-xxl-5">
                  <p className="b2b-title-text text-white text-center mb-0">
                    {description_right}
                  </p>
                </div>
              </div>
